...
void RayTracing::initShaders() {
    ...
    m_raytracingShader->attachVertexShaderFromFile(getAssetFullPath(raytracingVsRelPath));
    m_raytracingShader->attachFragmentShaderFromFile(getAssetFullPath(raytracingFsRelPath));
