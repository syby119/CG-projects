...
void PbrViewer::initShaders() {
    ...
    m_pbrShader->attachVertexShaderFromFile(getAssetFullPath(pbrVertShaderRelPath), version);
    m_pbrShader->attachFragmentShaderFromFile(getAssetFullPath(pbrFragShaderRelPath), version);
    m_pbrShader->link();
    ...
    m_quadShader->attachVertexShaderFromFile(getAssetFullPath(quadVertShaderRelPath), version);
    m_quadShader->attachFragmentShaderFromFile(getAssetFullPath(quadFragShaderRelPath), version);
    m_quadShader->link();
}
