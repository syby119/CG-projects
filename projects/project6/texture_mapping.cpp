...
void TextureMapping::initSimpleShader() {
    ...
    m_simpleShader->attachVertexShader(vsCode);
    m_simpleShader->attachFragmentShader(fsCode);
    m_simpleShader->link();
}
...
void TextureMapping::initBlendShader() {
    ...
    m_blendShader->attachVertexShader(vsCode);
    m_blendShader->attachFragmentShader(fsCode);
    m_blendShader->link();
}
...
void TextureMapping::initCheckerShader() {
    ...
    m_checkerShader->attachVertexShader(vsCode);
    m_checkerShader->attachFragmentShader(fsCode);
