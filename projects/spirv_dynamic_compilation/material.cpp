    ...
    for (auto const& [fullname, varInfo] : m_program->getUniformVarInfos()) {
        if (fullname.starts_with(m_materialFieldPrefix)) {
            ...
            case GLProgram::VarType::BVec2:
                m_attributeInfos[name] = {
                    varInfo.location, varInfo.type, isColor, glm::bvec2{false}};
                break;
            case GLProgram::VarType::BVec3:
                m_attributeInfos[name] = {
                    varInfo.location, varInfo.type, isColor, glm::bvec3{false}};
                break;
            case GLProgram::VarType::BVec4:
                m_attributeInfos[name] = {
                    varInfo.location, varInfo.type, isColor, glm::bvec4{false}};
                break;
            ...
            case GLProgram::VarType::Mat2x2:
                m_attributeInfos[name] = {
                    varInfo.location, varInfo.type, isColor, glm::mat2x2(0.0f)};
                break;
            case GLProgram::VarType::Mat2x3:
                m_attributeInfos[name] = {
                    varInfo.location, varInfo.type, isColor, glm::mat2x3(0.0f)};
                break;
            case GLProgram::VarType::Mat2x4:
                m_attributeInfos[name] = {
                    varInfo.location, varInfo.type, isColor, glm::mat2x4(0.0f)};
                break;
            case GLProgram::VarType::Mat3x2:
                m_attributeInfos[name] = {
                    varInfo.location, varInfo.type, isColor, glm::mat3x2(0.0f)};
                break;
            case GLProgram::VarType::Mat3x3:
                m_attributeInfos[name] = {
                    varInfo.location, varInfo.type, isColor, glm::mat3x3(0.0f)};
                break;
            case GLProgram::VarType::Mat3x4:
                m_attributeInfos[name] = {
                    varInfo.location, varInfo.type, isColor, glm::mat3x4(0.0f)};
                break;
            case GLProgram::VarType::Mat4x2:
                m_attributeInfos[name] = {
                    varInfo.location, varInfo.type, isColor, glm::mat4x2(0.0f)};
                break;
            case GLProgram::VarType::Mat4x3:
                m_attributeInfos[name] = {
                    varInfo.location, varInfo.type, isColor, glm::mat4x3(0.0f)};
                break;
            case GLProgram::VarType::Mat4x4:
                m_attributeInfos[name] = {
                    varInfo.location, varInfo.type, isColor, glm::mat4x4(0.0f)};
                break;
            case GLProgram::VarType::DMat2x2:
                m_attributeInfos[name] = {
                    varInfo.location, varInfo.type, isColor, glm::dmat2x2(0.0)};
                break;
            case GLProgram::VarType::DMat2x3:
                m_attributeInfos[name] = {
                    varInfo.location, varInfo.type, isColor, glm::dmat2x3(0.0)};
                break;
            case GLProgram::VarType::DMat2x4:
                m_attributeInfos[name] = {
                    varInfo.location, varInfo.type, isColor, glm::dmat2x4(0.0)};
                break;
            case GLProgram::VarType::DMat3x2:
                m_attributeInfos[name] = {
                    varInfo.location, varInfo.type, isColor, glm::dmat3x2(0.0)};
                break;
            case GLProgram::VarType::DMat3x3:
                m_attributeInfos[name] = {
                    varInfo.location, varInfo.type, isColor, glm::dmat3x3(0.0)};
                break;
            case GLProgram::VarType::DMat3x4:
                m_attributeInfos[name] = {
                    varInfo.location, varInfo.type, isColor, glm::dmat3x4(0.0)};
                break;
            case GLProgram::VarType::DMat4x2:
                m_attributeInfos[name] = {
                    varInfo.location, varInfo.type, isColor, glm::dmat4x2(0.0)};
                break;
            case GLProgram::VarType::DMat4x3:
                m_attributeInfos[name] = {
                    varInfo.location, varInfo.type, isColor, glm::dmat4x3(0.0)};
                break;
            case GLProgram::VarType::DMat4x4:
                m_attributeInfos[name] = {
                    varInfo.location, varInfo.type, isColor, glm::dmat4x4(0.0)};
                break;
            }
        }
    }
