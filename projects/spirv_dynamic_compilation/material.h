...
public:
    using Attribute = std::variant<
        bool, glm::bvec2, glm::bvec3, glm::bvec4, int, glm::ivec2, glm::ivec3, glm::ivec4, unsigned,
        glm::uvec2, glm::uvec3, glm::uvec4, float, glm::vec2, glm::vec3, glm::vec4, double,
        glm::dvec2, glm::dvec3, glm::dvec4, glm::mat2x2, glm::mat2x3, glm::mat2x4, glm::mat3x2,
        glm::mat3x3, glm::mat3x4, glm::mat4x2, glm::mat4x3, glm::mat4x4, glm::dmat2x2, glm::dmat2x3,
        glm::dmat2x4, glm::dmat3x2, glm::dmat3x3, glm::dmat3x4, glm::dmat4x2, glm::dmat4x3,
        glm::dmat4x4>;
...
public:
    ...
    std::shared_ptr<GLProgram> getProgram() const {
        return m_program;
    }
    ...
    std::map<std::string, AttributeInfo> const& getArributeInfos() const noexcept {
        return m_attributeInfos;
    }

    std::map<std::string, TextureInfo> const& getTextureInfos() const noexcept {
